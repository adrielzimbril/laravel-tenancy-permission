...
return [
    ...
    'models' => [
         ...
         * `Oricodes\TenantPermission\Contracts\Role` contract.
         */

        'role' => Oricodes\TenantPermission\Models\Role::class,
    ...
    'column_names' => [
         ...
         */
        'role_pivot_key' => 'tenant_role_id', //default 'role_id',
        ...
        'team_foreign_key' => 'tenant_team_id',
    ],
